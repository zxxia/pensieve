...
class ActorNetwork(object):
    ...
    def create_actor_network(self):
        with tf.variable_scope('actor'):
            ...
            split_0 = tflearn.fully_connected( inputs[:, 0:1, -1], 2, activation='relu' )
            split_1 = tflearn.fully_connected( inputs[:, 1:2, -1], 2, activation='relu' )
            split_2 = tflearn.conv_1d( inputs[:, 2:3, :], 2, 4, activation='relu' )
            split_3 = tflearn.conv_1d( inputs[:, 3:4, :], 2, 4, activation='relu' )
            split_4 = tflearn.conv_1d( inputs[:, 4:5, :A_DIM], 2, 4, activation='relu' )
            split_5 = tflearn.fully_connected( inputs[:, 5:6, -1], 2, activation='relu' )
            ...
            dense_net_0 = tflearn.fully_connected(merge_net, 2, activation='relu')
