...
# TRAIN_TRACE_DIR = "../data/synthetic-train-close-random/train_maxBW_2"
# VAL_TRACE_DIR = "../data/synthetic-train-close-random/val_maxBW_2"
TEST_TRACE_DIR = "../data/synthetic-train-close-random/test_maxBW_5"
