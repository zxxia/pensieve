...
TRAIN_TRACE_PATH_1="../data/synthetic_traces/train_Ts_100"
VAL_TRACE_PATH_1="../data/synthetic_traces/val_Ts_100"
...
SUMMARY_DIR_1="../results/synthetic-train/train_Ts_100"
