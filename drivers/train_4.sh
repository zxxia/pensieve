...
TRAIN_TRACE_PATH_1="../data/Norway-DR-exp/train-norm-1-1-noise"
VAL_TRACE_PATH_1="../data/Norway-DR-exp/val-norm-1-1-noise"
...
SUMMARY_DIR_1="../results/Norway-DR-train/multiply-norm-1-1-train"
