...
TRAIN_TRACE_PATH_1="../data/Norway-DR-exp/train-3-noise"
VAL_TRACE_PATH_1="../data/Norway-DR-exp/val-3-noise"
...
SUMMARY_DIR_1="../results/Norway-DR-train/multiply-uniform-3-train"
