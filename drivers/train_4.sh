...
TRAIN_TRACE_PATH_1="../data/Norway-DR-exp/train-2.6-noise"
VAL_TRACE_PATH_1="../data/Norway-DR-exp/val-2.6-noise"
...
SUMMARY_DIR_1="../results/Norway-DR-train/multiply-uniform-2.6-train"
