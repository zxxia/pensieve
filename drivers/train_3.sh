...
TRAIN_TRACE_PATH_1="../data/synthetic_Ts_train/train_Ts_80"
VAL_TRACE_PATH_1="../data/synthetic_Ts_train/val_Ts_80"
...
SUMMARY_DIR_1="../results/synthetic-train/Ts-train-new/train_Ts_80"
