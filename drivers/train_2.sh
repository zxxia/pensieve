...
TRAIN_TRACE_PATH_1="../data/synthetic-train/train_maxBW_20"
VAL_TRACE_PATH_1="../data/synthetic-train/val_maxBW_20"
...
SUMMARY_DIR_1="../results/synthetic-train/mpc-6-train-subset/bitrate-6-train-20"
