...
TRAIN_TRACE_PATH_1="../data/synthetic-train/training_60"
VAL_TRACE_PATH_1="../data/synthetic-train/training_60_val"
...
SUMMARY_DIR_1="../results/synthetic-train/training-60"
