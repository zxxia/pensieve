...
TRAIN_TRACE_PATH_1="../data/Norway-DR-exp/train-norm-5-5-noise"
VAL_TRACE_PATH_1="../data/Norway-DR-exp/val-norm-5-5-noise"
...
SUMMARY_DIR_1="../results/Norway-DR-train/multiply-norm-5-5-train"
