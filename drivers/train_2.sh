...
TRAIN_TRACE_PATH_1="../data/synthetic_Ts_train/train_Ts_20"
VAL_TRACE_PATH_1="../data/synthetic_Ts_train/val_Ts_20"
...
SUMMARY_DIR_1="../results/synthetic-train/Ts-train/train_Ts_20"
