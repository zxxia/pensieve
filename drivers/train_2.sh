...
TRAIN_TRACE_PATH_1="../data/synthetic_Ts_train/train_Ts_30"
VAL_TRACE_PATH_1="../data/synthetic_Ts_train/val_Ts_30"
...
SUMMARY_DIR_1="../results/synthetic-train/Ts-train-new/train_Ts_30"
