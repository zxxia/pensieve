...
NN_MODELS="../results/synthetic-train/train-60/model_saved/nn_model_ep_27200.ckpt"
...
#        SUMMARY_DIR="../results/synthetic-test/large-range-test/trace-2000-train-100/test-on-${i_folder}"
