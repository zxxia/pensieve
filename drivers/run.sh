...
NN_MODELS="../results/Norway+LVC-DR-train/multiply-1-2-train/model_saved/nn_model_ep_49300.ckpt"
#RANDOM_SEED=41


    for RANDOM_SEED in 1; do
      SUMMARY_DIR="../results/DR-test/Norway+LVC-multiply-1-2-49300/seed_${RANDOM_SEED}"
