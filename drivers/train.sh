...
TRAIN_TRACE_PATH_1="../data/synthetic-train-close-random/train_maxBW_5"
VAL_TRACE_PATH_1="../data/synthetic-train-close-random/val_maxBW_5"
...
SUMMARY_DIR_1="../results/synthetic-train/close-random/1-bitrate-6-train-5"
