...
TRAIN_TRACE_PATH_1="../data/Norway-DR-exp/train-2.2-noise"
VAL_TRACE_PATH_1="../data/Norway-DR-exp/val-2.2-noise"
...
SUMMARY_DIR_1="../results/Norway-DR-train/multiply-uniform-2.2-train"
