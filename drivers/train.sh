...
TRAIN_TRACE_PATH_1="../data/synthetic-train/training_20"
VAL_TRACE_PATH_1="../data/synthetic-train/training_20_val"
...
SUMMARY_DIR_1="../results/synthetic-train/training-20"
